...
function Sfsh({settings}:{settings:Settings}) {
  const pdfView = 'https://drive.google.com/file/d/1piI9qsBtvwWmqekjsiNA1FDbsrOGyFub/view?usp=sharing';
  const pdfDownload = 'https://drive.google.com/uc?export=download&id=1piI9qsBtvwWmqekjsiNA1FDbsrOGyFub';
  return <Shell>
    ...
    <section id="trabajo" className="section section-light sfsh-results-block"><div className="container"><p className="eyebrow">Trabajo e ingresos</p><div className="sfsh-claims-grid sfsh-claims-light"><article><strong>25%</strong><p>de las familias encuestadas: ningún integrante tiene trabajo.</p></article><article><strong>42%</strong><p>de las personas tiene trabajo.</p></article><article><strong>58%</strong><p>que trabaja, y de ese grupo un <b>70%</b> tiene “trabajo temporal”.</p></article><article><strong>30%</strong><p>de las familias pidió fiado o un crédito los últimos 30 días.</p></article></div></div></section>
